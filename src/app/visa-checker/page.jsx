...
// Single source of truth for g status lookup: case-insensitive, tolerant of
    ...
    <>
      ...
      <div className="visa-page">
        <div className="visa-container">
          ...
          {/* ── HERO HEADER ─────────────────────────────────────────── */}
          <header style={{ marginBottom: 36 , marginTop: 50}}>
...
{/* Result */}
            {result && meta && (
              <div style={{ marginTop: 20, borderRadius: 18, border: `2px solid ${meta.color}`, background: meta.light, overflow: "visible", animation: "fadeUp 0.3s ease" }}>
                <div className={`visa-result-route${meta.slug === "visa-free" ? " visa-free" : ""}`}>
