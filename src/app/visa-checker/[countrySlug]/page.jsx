...
export async function generateMetadata({ params }) {
  ...
  if (destination) {
    ...
    return {
      ...
      description: `Visa requirements for ${passport} passport holders travelling to ${destination}. Check visa status, fees, documents needed, and apply with Visa Express – IATA-accredited travel consultancy.`,
      keywords: [
